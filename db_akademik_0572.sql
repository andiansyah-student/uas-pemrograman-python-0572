...
--
-- Host: localhost
-- Generation Time: Jan 25, 2022 at 10:05 AM
...
--
-- Database: `db_akademik_0572`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0572`
--

CREATE TABLE `tbl_students_0572` (
  `id` int(100) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0572`
--

INSERT INTO `tbl_students_0572` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
(51, '20.83.0572', 'Raihan Rinto Andiansyah', 'L', 'Teknik Komputer', 'Bantul');
...
--
-- Indexes for table `tbl_students_0572`
--
ALTER TABLE `tbl_students_0572`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0572`
--
ALTER TABLE `tbl_students_0572`
